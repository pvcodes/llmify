...
const pricingList: PricingProps[] = [
  {
    ...
    price: 0,
    description:
      "Explore all LLMs with your API key.",
  ...
  },
  {
    ...
    price: 299,
    description:
      "Unlock more potential with our Premium plan.",
    buttonText: "Get Started",
    benefitList: [
      "Unlimited Chats",
      "Change models anytime during chat",
  ...
  },
  {
    ...
    price: 999,
    description:
      "Maximize your capabilities with our Enterprise plan.",
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {pricingList.map((pricing: PricingProps) => (
          ...
          >
            ...
            <CardContent>
              <Button className="w-full" disabled={pricing.title !== 'Free'}>{pricing.buttonText}</Button>
            </CardContent>
