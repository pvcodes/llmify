        ...
        <Sidebar className="border-r relative">
            ...
            <div className="sticky top-0 z-10  p-2 flex items-center justify-between bg-gray-100 dark:bg-gray-600">
                ...
                <Button
                    ...
                    asChild
                >
                    <Link href="/new" aria-label="New Chat" className={`${buttonVariants({
                        variant: 'secondary'
                    })}`}>
                            ...
                            {chats.length > 0 ? (
                                chats.map((chat) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute left-0 top-0 w-1 h-full opacity-0 group-hover:opacity-100 transition-opacity rounded-l-md"></div>
                                    </SidebarMenuItem>
                                ))
                            ) : (
                                <SidebarMenuItem>
