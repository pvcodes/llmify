...
export default function ChatNameEditable({ chat, className }: ChatNameEditableProps) {
    ...
    return (
        <div
            className={cn("flex items-center w-full px-2 py-1.5 hover:bg-muted rounded-md group/chat",
        ...
        >
            {isEditing ? (
                ...
                <div className="flex items-center w-full justify-between">
                    ...
                    >
                        <span className="whitespace-nowrap overflow-hidden text-ellipsis block w-[250px] md:w-full">{name}</span>
                    </Link>
                    <Button
                        variant="ghost"
                        size="icon"
