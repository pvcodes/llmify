      ...
      <form className='space-y-6' onSubmit={handleSubmit}>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-sm text-muted-foreground'>
            If you have screenshots, upload here{' '}
            <Link href='https://imgbb.com' className='text-blue-700 hover:text-blue-400 underline'>
              imgbb
            </Link>{' '}
        ...
        {submitStatus && (
          <p
            className={`text-sm ${submitStatus.includes('Error') ? 'text-red-600' : 'text-green-600'}`}
          >
            {submitStatus}
          </p>
        )}
