...
export const ModelProviders: ModelProvider[] = ['OpenAI', 'Anthropic', 'DeepSeek', 'xAi'];
...
export function getModelsForProvider(tier: BillingLevel, provider: ModelProvider): ModelOption[] {
